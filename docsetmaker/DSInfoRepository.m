...
- (NSString *)classDefScript
{
    ...
    [script appendString:@"  end\n"];
    [script appendString:@"  def d_classes_and_structs\n"];
    [script appendString:@"    $ret = Array.new\n"];
    [script appendString:@"    $ret.concat @class_infos\n"];
    [script appendString:@"    $ret.concat @struct_infos\n"];
    [script appendString:@"    $ret = $ret.sort {|a, b| (a.d_name.downcase <=> b.d_name.downcase) }\n"];
    [script appendString:@"    return $ret\n"];
    [script appendString:@"  end\n"];
